...
# Dict used for convert the qcli.option_parsing.QcliOption.TYPES to Galaxy types
type_converter = {}
...
class OptionInfo(object):
    ...
    def __init__(self, option):
        """Creates the OptionInfo object from a qcli's option

        Input:
            option: a qcli.option_parsing.QcliOption object
        ...
        # Type boolean is not defined in qcli.option_parsing.QcliOption
        ...
        # We only need the first item of the _short_opts and _long_opts lists
        ...
        # the tgz file. Otherwise, we assume that the output file is a sub-type
        # of a txt file (txt, tab-delimited...)
        self.format = None
        if self.type == "output":
            self.format = "txt"
...
class ScriptInfo(object):
    ...
    def __init__(self, script_info_dict, script_name, command):
        ...
        Input:
            script_info_dict: a dictionary of objects which it is used in
                qcli.option_parsing to build the command line interfaces
                according to standards developed in the Knight Lab, and
                enforced in QIIME. (More info at:
                qcli.option_parsing.parse_command_line_parameters)
        ...
        if remove_opts:
            ...
            for name in opt_names:
                ...
                if opt:
                    ...
                    raise ValueError, "Option %s does not exists or it"%name +\
